...
1. Install WSL using Ubuntu 22.04 LTS if not installed already.
2. Launch WSL and install OpenFOAM following OpenFOAM Foundation instructions.
3. Using git, copy the repository files to desired folder.
4. Run OpenFOAM using commands found on the User Guide page.
